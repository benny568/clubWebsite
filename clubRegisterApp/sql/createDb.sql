...
values ( "Jonathan Leyden","12 High Garden, Ennis","0863231321", "", 3, 1, 0, "ACTIVE"),
	...
	("Paddy Honon","33 The Grove, Ennis","0864051423", "", 21, 4, 0, "ACTIVE"),
	("Tadgh Connellan","Ross Hill, Ennis","0851208695", "", 21, 4, 0, "ACTIVE"),
	("James Crotty","Ross Hill, Ennis","0872029157", "", 21, 2, 0, "ACTIVE"),
	("Nzube Okoye","Ross Hill, Ennis","0872025226", "", 21, 2, 0, "ACTIVE"),
	("Darren Meehan","Ross Hill, Ennis","0872996189", "", 21, 2, 0, "ACTIVE"),
	("Patrick McDade","Ross Hill, Ennis","0876873254", "", 21, 99, 0, "ACTIVE"),
	("Killian O'Daly","Ross Hill, Ennis","0876470883", "", 21, 3, 0, "ACTIVE"),
	("Tomás Hehir","Ross Hill, Ennis","0863647434", "", 21, 4, 0, "ACTIVE"),
	("David Roche","Ross Hill, Ennis","0852728382", "", 21, 4, 0, "ACTIVE"),
	("Michael Junaid","Ross Hill, Ennis","0877446858", "", 21, 4, 0, "ACTIVE"),
	("Sam Ogendare","Ross Hill, Ennis","0851358940", "", 21, 4, 0, "ACTIVE"),
	("Sean Murphy","Ross Hill, Ennis","0872861460", "", 21, 2, 0, "ACTIVE"),
	("Keith Shea","Ross Hill, Ennis","0877854002", "", 21, 2, 0, "ACTIVE"),
	("Mikey Whelan","Ross Hill, Ennis","", "", 21, 2, 0, "ACTIVE"),
	("Gavin Cooney","Ross Hill, Ennis","0862536423", "", 21, 3, 0, "ACTIVE"),
	("James Tierney","Ross Hill, Ennis","0864425778", "", 21, 3, 0, "ACTIVE"),
	("Sean Kennedy","Ross Hill, Ennis","0851487510", "", 21, 3, 0, "ACTIVE"),
	("Aidan Griffey","Ross Hill, Ennis","0877844717", "", 21, 4, 0, "ACTIVE"),
	("Aiden Kennedy","Ross Hill, Ennis","0868419095", "", 21, 4, 0, "ACTIVE"),
    ("Ikem Ugwueru","Ross Hill, Ennis","0877620262", "", 21, 4, 0, "ACTIVE"),
	("Brendan O'Daly","Reaskaun, Larchill, Ennis","0876470883", "", 21, 0, 0, "ACTIVE"),
    ("Nigel Braddish","Ross Hill, Ennis","0872873996", "", 21, 0, 0, "ACTIVE"),
...
values ("U6", 0), ("U7", 0), ("U8", 0), ("U9", 0), ("U10 Red", 0), ("U10 White", 0), ("U10 Yellow", 0), ("U11 Red", 672936870), ("U11 Yellow", 293150747), ("U12A", 898378654), ("U12B", 581109106), ("U12 Yellow", 0),("U13A", 334178093), ("U13B", 874844096), ("U14A", 155756020),
...
values	(21,'2015/07/05', 'First U8 session at Rosleven'),
		(21,'2015/07/12', 'U8 session at Rosleven'),
        (21,'2015/07/19', 'U8 session at Rosleven'),
        (21,'2015/07/24', 'U8 session at Rosleven'),
        (21,'2015/07/31', 'U8 session at Rosleven'),
        (21,'2015/08/06', 'U8 session at Rosleven'),
        (21,'2015/08/13', 'U8 session at Rosleven'),
        (21,'2015/08/20', 'U8 session at Rosleven');
