...
<body ng-controller="newsController">
	...
	<div class="panel" style="margin-top:5px;">
		...
		<div class="panel-body avenue-body">
			<div class="col-md-4">
				<img src="resources/images/adverts/enzos.png" height="50"alt="Club Colours" data-toggle="tooltip" data-placement="top" title="Sponsor: Enzos Takeaway"/>
			</div>
			<div class="col-md-4">
				<img src="resources/images/adverts/main-sponsor.png" data-toggle="tooltip" data-placement="top" title="Sponsor: Rochfords Pharmacy" width="300px" />
			</div>
			<div class="col-md-4">
