// Karma configuration
// Generated on Wed Feb 10 2016 22:50:32 GMT+0000 (GMT Standard Time)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
			...
			'js/modules/*.js',			// application sources
			'js/controllers/*.js',
			'js/directives/*.js',
			'js/services/*.js',
			'js/tests/dataService.test.js'
			//'js/tests/mmController.test.js',
			//'js/tests/lrDisplayService.test.js'
    ],
